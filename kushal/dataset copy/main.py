...
def contact():
    mess._show(title='Contact us', message="Please contact us on : '17B91A0561@cvr.ac.in' ")
...
message3 = tk.Label(window, text="ATSCV" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
